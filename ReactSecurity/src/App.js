...
function App() {
    ...
    /*
     ...
     1. index(home) 페이지를 먼저 들어가서 로그인 페이지으로 이동한 경우 -> index 페이지로 이동
     2. 탭을 열자마자 주소창에 수동입력을 통해 로그인 페이지로 이동한 경우 -> index 페이지로 이동
     3. 로그인 후 사용 가능한 페이지로 들어갔을 때 로그인 페이지로 이동한 경우 -> 해당 페이지로 이동
